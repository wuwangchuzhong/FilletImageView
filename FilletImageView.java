...
public class FilletImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            TypedArray four = context.obtainStyledAttributes(attrs, R.styleable.RoundFourImageView);
            roundLeftUp = four.getBoolean(R.styleable.RoundFourImageView_roundLeftUp, false);
            roundLeftDown = four.getBoolean(R.styleable.RoundFourImageView_roundLeftDown, false);
            roundRightUp = four.getBoolean(R.styleable.RoundFourImageView_roundRightUp, false);
            roundRightDown = four.getBoolean(R.styleable.RoundFourImageView_roundRightDown, false);
        } else {
